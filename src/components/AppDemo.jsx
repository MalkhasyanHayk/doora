    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-gradient`} x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#e44d4d" />
          <stop offset="100%" stopColor="#e44d4d" stopOpacity="0" />
        </linearGradient>
      </defs>
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: '#e44d4d', animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
  ...
  return (
    <AppScreen>
      <AppScreen.Body>
        ...
        {/*      {percentageChange && (*/}
        {/*        <div*/}
        {/*            style={{color: percentageChange >= 0 ? 'var(--primary)' : 'var(--secondary)'}}*/}
        {/*          className={clsx(*/}
        ...
        {/*      <div>1D</div>*/}
        {/*      <div>5D</div>*/}
        {/*      <div style={{color: 'var(--primary)'}} className="font-semibold text-cyan-600">1M</div>*/}
        {/*      <div>6M</div>*/}
        {/*      <div>1Y</div>*/}
        {/*      <div>5Y</div>*/}
        {/*    </div>*/}
        ...
        {/*      />*/}
        {/*    </div>*/}
        {/*    <div style={{backgroundColor: 'var(--primary)'}} className="mt-4 rounded-lg bg-cyan-500 px-4 py-2 text-center text-sm font-semibold text-white">*/}
        {/*      Trade*/}
        {/*    </div>*/}
        ...
        {/*  </div>*/}
        {/*</div>*/}
        <Image src={Background.src} alt={"main-image"} style={{width: "100%"}} sizes={"100%"} fill/>
      </AppScreen.Body>
    </AppScreen>
  )
}
