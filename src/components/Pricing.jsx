...
function Plan({
    ...
    return (
        ...
        >
            ...
            >
                <Logo className={clsx('h-4 w-auto flex-none', logomarkClassName)}/>
                ...
                >
                    {features.map((feature) => (
                        <li key={feature} className="flex py-2">
                            <CheckIcon
                                style={{color: featured ? "white" : "var(--primary)"}}
                                className={clsx(
                                    'h-6 w-6 flex-none',
            ...
            <Button
                href={button.href}
                style={{backgroundColor: featured ? "var(--primary)" : "var(--secondary)"}}
