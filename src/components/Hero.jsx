                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                    <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                        <h1 className="text-4xl font-medium tracking-tight text-gray-900">
                            Einfache Verwaltung von Türen und Toren
                        </h1>
                        <p className="mt-6 text-lg text-gray-600">
                            Doora.ch ist ein modernes IoT-System und eine Online-Plattform, die es Ihnen ermöglicht,
                            automatische Türen und Tore in Echtzeit zu steuern, zu überwachen und zu kontrollieren. Die
                            einfache und bequeme Verwaltung ist von jedem Gerät aus möglich, was den Kontrollprozess
